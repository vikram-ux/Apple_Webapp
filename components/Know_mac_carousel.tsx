...
const data = [
  ...
  },
  {
    ...
    title: "Join free sessions at your Apple Store.- (opens in new window)",
  ...
  },
  {
    ...
    category: " BUSINESS",
    title: "From enterprise to small business, we’ll work with you. Footnote ¹- (opens in new window).",
